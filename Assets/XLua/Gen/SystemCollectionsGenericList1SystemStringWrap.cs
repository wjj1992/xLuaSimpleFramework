...
namespace CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1SystemStringWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(System.Collections.Generic.List<string>), L, translator, 0, 29, 2, 1);
			...
			Utils.EndObjectRegister(typeof(System.Collections.Generic.List<string>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(System.Collections.Generic.List<string>), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.List<string>));
			
			
			Utils.EndClassRegister(typeof(System.Collections.Generic.List<string>), L, translator);
        }
